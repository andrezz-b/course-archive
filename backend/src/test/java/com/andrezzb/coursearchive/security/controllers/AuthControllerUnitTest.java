...
public class AuthControllerUnitTest {
    ...
    class Login {
        ...
        void givenMissingUsername_whenLogin_thenShouldFail() throws Exception {
            var loginData = LoginDto.LoginBody.builder()
            ...
            mvc.perform(MockMvcRequestBuilders.post(LOGIN_URL)
                    ...
                    .andExpectAll(
                            ...
                            MockMvcResultMatchers.jsonPath("$.errors[0]")
        ...
        void givenValidCredentials_whenLogin_thenShouldReturnToken() throws Exception {
            ...
            var loginReseponse = LoginDto.LoginResponse.builder()
                    .accessToken("testtoken")
                    .refreshToken("testrefreshtoken")
                    .build();
            when(authService.login(anyString(), anyString())).thenReturn(loginReseponse);
