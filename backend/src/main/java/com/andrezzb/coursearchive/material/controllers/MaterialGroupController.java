...
public class MaterialGroupController {
  ...
  @GetMapping("/")
  public ResponseEntity<Page<MaterialGroup>> getAllMaterialGroups(
    ...
    final var materialGroupsPaged = materialGroupService.findAllMaterialGroupsPaged(p);
    return ResponseEntity.ok(materialGroupsPaged);
  }

  @PostMapping("/")
  public ResponseEntity<MaterialGroup> createMaterialGroup(
  ...
  @PutMapping("/{id}")
  public ResponseEntity<MaterialGroup> updateMaterailGroupById(@PathVariable Long id,
